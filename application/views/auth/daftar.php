                ...
                <form action="<?= base_url("Authentification/registration") ?>" method="post">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <?= form_error('id_instansi', ' <small class="text-danger pl-3">', '</small>') ?>
                        </div>
                        <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <div class="form-group">
                        <label for="brand_partner">Nama Instansi *</label>
                        <input type="text" name="instansi" id="instansi" <?= set_value('instansi') ?> class="form-control" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <button type="submit" name=add class="form-control btn btn-primary btn-user btn-block">
